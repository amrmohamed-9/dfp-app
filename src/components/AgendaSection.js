// src/components/AgendaTopics.js
import React, { useEffect, useState } from 'react';
import './css/AgendaSection.css'; // للأنماط المخصصة
...
const AgendaTopics = () => {
  ...
  useEffect(() => {
    ...
    // تحديث حالة StickyBox بناءً على حجم الشاشة
    const handleResize = () => {
      setIsStickyEnabled(window.innerWidth > 768);
    };

    handleResize(); // استدعاء مبدئي عند تحميل الصفحة
